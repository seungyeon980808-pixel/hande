...
export function RequestForm({teachers}:{teachers:Teacher[]}){
  ...
  return <form onSubmit={submit} className="card card-pad form-grid">
    ...
    {type==="document"&&mode==="individual"&&<div className="field full"><label>작년 자료 (선택)</label><FileDrop name="reference" accept=".hwp,.hwpx" hint="작년 완성본" initial={handoff?.reference??undefined} badge="앞 화면에서 넘어온 작년 자료"/><span className="help">함께 올리면 제출 화면에서 작년 문서를 왼쪽에 나란히 띄워 복사·붙여넣기 할 수 있습니다.</span></div>}
