...
export async function POST(request:Request){
  ...
  try{
    ...
    const parsed=schema.safeParse({type:form.get("type"),mode:form.get("mode")??"individual",title:form.get("title"),description:form.get("description")??"",deadline:form.get("deadline"),recipientIds:form.getAll("recipientIds"),targetYear:form.get("targetYear")||DEFAULT_TARGET_YEAR});
